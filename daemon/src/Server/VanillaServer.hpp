...
#ifndef DAEMON_SERVER_VANILLASERVER_HPP_
#define DAEMON_SERVER_VANILLASERVER_HPP_
...
/**
 * Class handling Vanilla minecraft servers.
 */
...
#endif /* DAEMON_SERVER_VANILLASERVER_HPP_ */
