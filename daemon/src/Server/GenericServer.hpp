...
#ifndef DAEMON_SERVER_GENERICSERVER_HPP_
#define DAEMON_SERVER_GENERICSERVER_HPP_
...
/**
 * Class handling generic minecraft servers.
 */
...
#endif /* DAEMON_SERVER_GENERICSERVER_HPP_ */
