...
#ifndef DAEMON_SERVER_BUKKITSERVER_HPP_
#define DAEMON_SERVER_BUKKITSERVER_HPP_
...
/**
 * Class handling Bukkit minecraft servers.
 */
...
#endif /* DAEMON_SERVER_BUKKITSERVER_HPP_ */
